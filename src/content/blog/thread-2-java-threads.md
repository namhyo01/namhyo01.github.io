...
description: '본격적으로 스레드에 대해 배워보자'
pubDate: 2022-12-26
...
![image](../../assets/blog/thread-2-java-threads-1.png)

자 보면 스레드 하나가 있고, 위에서 설명한 대로 register, stack, pc(는 안보인다 지금은), code, data, files가 있는 것을 확인 가능하다.

### 멀티 스레드 프로세스

![image](../../assets/blog/thread-2-java-threads-2.png)
...
![image](../../assets/blog/thread-2-java-threads-3.png)
...
![image](../../assets/blog/thread-2-java-threads-4.png)

스레드는 만들어지고 start를 안한다면 실행을 안한다.

그래서 start를 하면 Alive 상태가 되고, run이 끝나거나 stop이 나오면 종료가 된다.

![image](../../assets/blog/thread-2-java-threads-5.png)
