...
![](/assets/img/posts/go-random-thread-unsafe-1.png)
...
![](/assets/img/posts/go-random-thread-unsafe-2.png)

음 솔직히 문제가 없다  
하지만 시간이 더 지나니...

![](/assets/img/posts/go-random-thread-unsafe-3.png)
